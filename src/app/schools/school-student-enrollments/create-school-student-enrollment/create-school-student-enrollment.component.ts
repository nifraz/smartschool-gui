...
@Component({
  selector: 'app-create-school-student-enrollment',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
  ...
  templateUrl: './create-school-student-enrollment.component.html',
...
export class CreateSchoolStudentEnrollmentComponent<SchoolStudentEnrollmentModel> extends FormComponent<SchoolStudentEnrollmentModel> {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<CreateSchoolStudentEnrollmentComponent<SchoolStudentEnrollmentModel>>,
