...
@Component({
  selector: 'app-user-school-student-enrollment-request-details',
  standalone: true,
  imports: [
    CommonModule,
    NotFoundComponent,
  ...
  templateUrl: './user-school-student-enrollment-request-details.component.html',
  styleUrl: './user-school-student-enrollment-request-details.component.scss'
})
export class UserSchoolStudentEnrollmentRequestDetailsComponent extends RecordComponent<SchoolStudentEnrollmentRequestModel> implements OnInit {
